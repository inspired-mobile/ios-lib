...
public class SKBrowserControlsView: UIView {
    ...
    func initWithSourceKitBrowser(p_skBrowser: SKBrowser2) -> Any?
    {
        ...
        print("REXCT =========== %@",NSCoder.string(for: controlsToolbar.frame));
...
//UIImage(named: "BackButton.png")
        ...
        flexBack = UIBarButtonItem(barButtonSystemItem: UIBarButtonItem.SystemItem.flexibleSpace, target: nil, action: nil)
        ...
        flexForward = UIBarButtonItem(barButtonSystemItem: UIBarButtonItem.SystemItem.flexibleSpace, target: nil, action: nil)
            
            let placeHolder = UIView()
            placeHolder.frame = CGRect(x: 0, y: 0, width: 30.0, height:44.0)
            loadingIndicator = UIBarButtonItem.init(customView: placeHolder)
        flexLoading = UIBarButtonItem.init(barButtonSystemItem: UIBarButtonItem.SystemItem.flexibleSpace, target: nil, action: nil)
        refreshButton = UIBarButtonItem.init(barButtonSystemItem: UIBarButtonItem.SystemItem.refresh, target: self, action: #selector(refresh))
        flexRefresh = UIBarButtonItem.init(barButtonSystemItem: UIBarButtonItem.SystemItem.flexibleSpace, target: nil, action: nil)
        launchSafariButton = UIBarButtonItem.init(barButtonSystemItem: UIBarButtonItem.SystemItem.action, target: self, action: #selector(launchSafari))
        flexLaunch = UIBarButtonItem.init(barButtonSystemItem: UIBarButtonItem.SystemItem.flexibleSpace, target: nil, action: nil)
        stopButton = UIBarButtonItem.init(barButtonSystemItem: UIBarButtonItem.SystemItem.stop, target: self, action: #selector(dismiss))
