...
public class SKMRAIDView2: UIView,UIWebViewDelegate,SKMRAIDModalViewControllerDelegate,UIGestureRecognizerDelegate,SKMRAIDServiceDelegate, WKUIDelegate, WKNavigationDelegate
{
    ...
    public override init(frame: CGRect)
    {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(didRotateFromInterfaceOrientation), name:  UIDevice.orientationDidChangeNotification, object: nil)
    }
    ...
    /*
     This method is to handle the location of the display ad, as well as the ad data. And all the settings for banner ads will be done inside.
     */
    ...
    @objc func didRotateFromInterfaceOrientation(fromInterfaceOrientation: NSNotification)
    {
        if (checkStr == "")
        {
           ...
           //     let _: Bool = UIInterfaceOrientationIsLandscape(interfaceOrientation)
                heightView = nil
    ...
    {
        closeEventRegion   = UIButton(type: UIButton.ButtonType.custom) as UIButton
        ...
        closeEventRegion.autoresizingMask = UIView.AutoresizingMask(rawValue: UIView.AutoresizingMask.RawValue(UInt8(UIView.AutoresizingMask.flexibleLeftMargin.rawValue) | UInt8(UIView.AutoresizingMask.flexibleBottomMargin.rawValue)))
    ...
    func showResizeCloseRegion()
    {
        ...
        {
            resizeCloseRegion? = UIButton(type: UIButton.ButtonType.custom) as UIButton
        ...
        case SKMRAIDCustomClosePosition.MRAIDCustomClosePositionBottomCenter:
            ...
            autoresizingMask = UIView.AutoresizingMask(rawValue: UIView.AutoresizingMask.RawValue(UInt8(UIView.AutoresizingMask.flexibleLeftMargin.rawValue) | UInt8(UIView.AutoresizingMask.flexibleRightMargin.rawValue)))
            break
        ...
        case SKMRAIDCustomClosePosition.MRAIDCustomClosePositionBottomRight:
            ...
            autoresizingMask = UIView.AutoresizingMask.flexibleLeftMargin
        ...
        case SKMRAIDCustomClosePosition.MRAIDCustomClosePositionCenter:
            ...
            autoresizingMask = UIView.AutoresizingMask(rawValue: UIView.AutoresizingMask.RawValue(UInt8(autoresizingMask.rawValue) | (UInt8(UIView.AutoresizingMask.flexibleTopMargin.rawValue) | UInt8(UIView.AutoresizingMask.flexibleBottomMargin.rawValue))))
            break
        ...
        case SKMRAIDCustomClosePosition.MRAIDCustomClosePositionBottomRight:
            ...
            autoresizingMask = UIView.AutoresizingMask(rawValue: UIView.AutoresizingMask.RawValue(UInt8(autoresizingMask.rawValue) | UInt8(UIView.AutoresizingMask.flexibleTopMargin.rawValue)))
...
//        let interfaceOrientation: UIInterfaceOrientation = UIApplication .shared .statusBarOrientation
    ...
    public func webView(_ wv: UIWebView, shouldStartLoadWith request: URLRequest, navigationType: UIWebView.NavigationType) -> Bool
    {
    ...
    public func mraidModalViewControllerDidRotate(modalViewController: SKMRAIDModalViewController)
    {
       // SkLogger .debug(tag: "MRAID - View", withMessage: String(format: "%@",NSStringFromSelector(#function)) as NSString)
        self .setScreenSize()
        self .fireSizeChangeEvent()
