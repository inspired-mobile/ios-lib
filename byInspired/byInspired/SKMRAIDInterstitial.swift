...
public class SKMRAIDInterstitial: NSObject, SKMRAIDViewDelegate, SKMRAIDServiceDelegate
{
   ...
   public var isViewable: Bool? {
    ...
    //********************initWithSupportedFeatures()********************
    /*
     This method is to handle the location of the display ad, as well as the ad data. And all the settings for interstitial ads will be done inside.
     */
    public func initWithSupportedFeatures(features: NSArray, withHtmlData htmlData: NSString, withBaseURL bsURL: NSURL, delegat: SKMRAIDInterstitialDelegate, serviceDelegat: SKMRAIDServiceDelegate, rootViewControllerr: UIViewController) -> Any
    {
