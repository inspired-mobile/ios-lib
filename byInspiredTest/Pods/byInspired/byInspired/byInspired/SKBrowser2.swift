   ...
   public func loadRequest(request: NSURLRequest)
    ...
    override public func viewDidAppear(_ animated: Bool)
    {
        ...
        if ((browserWebView) != nil)
        {
          ...
          //  getter:UIInterfaceOrientation.isLandscape(self:)
            
          //  isLandscape = UIInterfaceOrientation.isLandscape(interfaceOrientation)
            ...
            {
                print("browserControlsView FRAME%@", NSCoder.string(for: browserControlsView.frame));
            }
...
//            {
    ...
    convenience init()
    {
        ...
        let yourCustomNotificationName = Notification.Name("yourCustomNotificationName")
        
      //  NotificationCenter.default.addObserver(name: Notification.yourCustomNotificationName, object: nil)
    ...
    //    NotificationCenter.default.addObserver(UIApplication, selector:#selector: (didRotateFromInterfaceOrientation), name: UIDevice.orientationDidChangeNotification, object: nil)
