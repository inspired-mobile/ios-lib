...
//
        ...
        let portrait =  UIDevice.current.orientation.isPortrait
        let landscapee =  UIDevice.current.orientation.isLandscape

        
        
        if ((orientationProperties.forceOrientation == SKMRAIDForceOrientation.MRAIDForceOrientationPortrait && portrait) || (orientationProperties.forceOrientation == SKMRAIDForceOrientation.MRAIDForceOrientationLandscape && landscapee) || (orientationProperties.forceOrientation == SKMRAIDForceOrientation.MRAIDForceOrientationNone && preferredOrientation == currentInterfaceOrientation))
        {
            return
        }
